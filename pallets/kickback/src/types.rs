...
// https://docs.filebase.com/storage-networks/ipfs/ipfs-cids
// CIDv0 CIDs are 46 characters long and always start with the characters “Qm”.
// The first few bytes of a CIDv1 CID can be used to interpret the remainder of the CID and provide
// information about how to decode the content once it has been fetched from IPFS.
